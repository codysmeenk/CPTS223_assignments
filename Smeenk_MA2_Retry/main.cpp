...
Your answer:
    The BST is balanced on average meaning the height is logarithmic relative to
    the number of nodes, so the height of the BST after inserting random integers
    is O(log n).
